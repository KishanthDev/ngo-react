        ...
        <div className="flex flex-col md:flex-row h-full">
            ...
            <div className="space-y-2">
              {WEBSITE_SECTIONS.map((section) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${activeSection === section.id
          ...
          <div className="flex-1 p-6 lg:p-8">
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-10 flex flex-col items-center justify-center transition-all ${isUploading ? 'opacity-50 cursor-not-allowed border-gray-300 bg-gray-50' : 'cursor-pointer'
                } ${isDragging
